...
RSpec.describe Product, type: :model do
  ...
  describe "scope" do
    let!(:product_1){FactoryBot.create :product, name: "a", price: 10}
    ...
    context "sort product" do
      it "sort by name" do
        expect(Product.order_by_name).to eq [product_1, product_2, product_3]
      end
      it "sort by price" do
        expect(Product.sort_by_price).to eq [product_1, product_2, product_3]
      end
    end
  end
end
